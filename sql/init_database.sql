...
-- ---------------------------------------------
-- 3.9 补充预约（不同医生、取消状态、更多已完成）
-- ---------------------------------------------
INSERT INTO appointments (appointment_id, user_id, group_id, doctor_id, exam_date, exam_time_slot, status, payment_status) VALUES
-- 已取消
(14, 3, 9, 2, '2026-07-02', '上午', 'CANCELLED', FALSE),
(15, 2, 3, 2, '2026-06-28', '下午', 'CANCELLED', FALSE),
-- 更多已完成（不同医生）
(16, 1, 4, 3, '2026-07-03', '上午', 'COMPLETED', TRUE),
(17, 4, 2, 2, '2026-06-30', '上午', 'COMPLETED', TRUE),
(18, 5, 10, 5, '2026-07-01', '上午', 'COMPLETED', TRUE),
-- 未来预约（不同医生）
(19, 3, 7, 2, '2026-07-18', '上午', 'PENDING', TRUE),
(20, 1, 5, 3, '2026-07-20', '下午', 'PENDING', FALSE),
(21, 2, 6, 10, '2026-07-19', '上午', 'PENDING', TRUE),
(22, 5, 8, 4, '2026-07-22', '上午', 'PENDING', FALSE)
ON DUPLICATE KEY UPDATE appointment_id = appointment_id;

-- ---------------------------------------------
-- 3.10 补充检查结果（新增已完成预约 16-18）
-- ---------------------------------------------

-- 白领精英 赵小明 (appointment_id=16, doctor=3 王建国/检验科)
INSERT INTO check_results (appointment_id, item_id, doctor_id, result_value, is_abnormal, doctor_note, exam_date) VALUES
(16, 1,  1, '172',  FALSE, NULL, '2026-07-03 08:30'),
(16, 2,  1, '82',   TRUE,  '体重偏高，建议控制饮食', '2026-07-03 08:30'),
(16, 3,  1, '27.7', TRUE,  'BMI超重，建议减重至75kg以下', '2026-07-03 08:30'),
(16, 4,  1, '138',  FALSE, NULL, '2026-07-03 08:35'),
(16, 5,  1, '86',   FALSE, NULL, '2026-07-03 08:35'),
(16, 6,  1, '82',   FALSE, NULL, '2026-07-03 08:35'),
(16, 8,  3, '8.2',  FALSE, NULL, '2026-07-03 09:00'),
(16, 9,  3, '5.1',  FALSE, NULL, '2026-07-03 09:00'),
(16, 10, 3, '150',  FALSE, NULL, '2026-07-03 09:00'),
(16, 11, 3, '45',   FALSE, NULL, '2026-07-03 09:00'),
(16, 12, 3, '62',   FALSE, NULL, '2026-07-03 09:00'),
(16, 13, 3, '32',   FALSE, NULL, '2026-07-03 09:00'),
(16, 19, 3, '6.5',  TRUE,  '空腹血糖偏高，处于糖尿病前期，建议复查糖耐量', '2026-07-03 09:10'),
(16, 22, 3, '6.8',  TRUE,  '总胆固醇严重偏高，建议低脂饮食、增加运动', '2026-07-03 09:10'),
(16, 23, 3, '2.5',  TRUE,  '甘油三酯偏高', '2026-07-03 09:10'),
(16, 25, 3, '4.2',  TRUE,  '低密度脂蛋白偏高', '2026-07-03 09:10'),
(16, 32, 3, '55',   TRUE,  '谷丙转氨酶偏高，提示肝功能异常，建议戒酒、保肝治疗', '2026-07-03 09:15'),
(16, 33, 3, '48',   TRUE,  '谷草转氨酶偏高', '2026-07-03 09:15')
ON DUPLICATE KEY UPDATE result_id = result_id;

-- 基础B 李美丽 (appointment_id=17, doctor=2 李芳/外科)
INSERT INTO check_results (appointment_id, item_id, doctor_id, result_value, is_abnormal, doctor_note, exam_date) VALUES
(17, 1,  1, '160',  FALSE, NULL, '2026-06-30 08:30'),
(17, 2,  1, '54',   FALSE, NULL, '2026-06-30 08:30'),
(17, 3,  1, '21.1', FALSE, NULL, '2026-06-30 08:30'),
(17, 4,  1, '115',  FALSE, NULL, '2026-06-30 08:35'),
(17, 5,  1, '74',   FALSE, NULL, '2026-06-30 08:35'),
(17, 6,  1, '68',   FALSE, NULL, '2026-06-30 08:35'),
(17, 8,  3, '5.5',  FALSE, NULL, '2026-06-30 09:00'),
(17, 9,  3, '4.3',  FALSE, NULL, '2026-06-30 09:00'),
(17, 10, 3, '130',  FALSE, NULL, '2026-06-30 09:00'),
(17, 12, 3, '4.0',  FALSE, NULL, '2026-06-30 09:00'),
(17, 13, 3, '55',   FALSE, NULL, '2026-06-30 09:00'),
(17, 15, 3, '0.5',  FALSE, NULL, '2026-06-30 09:00'),
(17, 16, 3, '38',   FALSE, NULL, '2026-06-30 09:00')
ON DUPLICATE KEY UPDATE result_id = result_id;

-- 心脑血管专筛 周建国 (appointment_id=18, doctor=5 刘洋/超声科)
INSERT INTO check_results (appointment_id, item_id, doctor_id, result_value, is_abnormal, doctor_note, exam_date) VALUES
(18, 1,  1, '168',  FALSE, NULL, '2026-07-01 08:30'),
(18, 2,  1, '73',   FALSE, NULL, '2026-07-01 08:30'),
(18, 3,  1, '25.9', TRUE,  'BMI偏高', '2026-07-01 08:30'),
(18, 4,  1, '148',  TRUE,  '收缩压偏高', '2026-07-01 08:35'),
(18, 5,  1, '90',   FALSE, NULL, '2026-07-01 08:35'),
(18, 6,  1, '76',   FALSE, NULL, '2026-07-01 08:35'),
(18, 22, 3, '6.1',  TRUE,  '总胆固醇偏高', '2026-07-01 09:00'),
(18, 23, 3, '2.3',  TRUE,  '甘油三酯偏高', '2026-07-01 09:00'),
(18, 24, 3, '0.9',  FALSE, NULL, '2026-07-01 09:00'),
(18, 25, 3, '4.0',  TRUE,  '低密度脂蛋白偏高', '2026-07-01 09:00'),
(18, 60, 6, 'ST-T改变', TRUE, '心电图ST-T改变，提示心肌缺血可能，建议心内科进一步检查', '2026-07-01 09:30'),
(18, 64, 5, '右侧颈动脉斑块(大小约3.2×1.8mm)', TRUE, '颈动脉斑块形成，建议服用他汀类药物，定期复查', '2026-07-01 10:00')
ON DUPLICATE KEY UPDATE result_id = result_id;

-- ---------------------------------------------
-- 3.11 体检报告（所有已完成预约的综合报告）
-- ---------------------------------------------
INSERT INTO reports (report_id, appointment_id, doctor_id, summary, upload_time) VALUES
-- 银发关怀 周建国 (appointment_id=5) — 多项异常
(1, 5, 1,
 '【综合评估】\n'
 '本次体检发现多项异常指标，需引起重视。\n\n'
 '【主要异常】\n'
 '1. 体重管理：BMI 25.5，属于超重范围，建议控制饮食热量摄入，每周至少150分钟中等强度有氧运动。\n'
 '2. 血压：155/92mmHg，达到1级高血压标准。建议低盐饮食（每日<6g），监测血压变化，必要时心内科就诊。\n'
 '3. 血糖：空腹血糖6.8mmol/L，处于糖尿病前期。建议行OGTT糖耐量试验，控制碳水化合物摄入。\n'
 '4. 血脂：总胆固醇6.2mmol/L，偏高。建议低脂饮食，增加膳食纤维摄入。\n'
 '5. 肾功能：尿素氮9.5mmol/L、肌酐118μmol/L均偏高，建议低蛋白饮食，1个月后复查肾功能。\n'
 '6. 腹部彩超：提示轻度脂肪肝，与超重、血脂异常相关，减重为首要措施。\n\n'
 '【建议】\n'
 '1. 立即启动生活方式干预（饮食+运动），目标3个月内减重5kg。\n'
 '2. 心内科、内分泌科、肾内科门诊随访。\n'
 '3. 3个月后复查全套。',
 '2026-07-09 16:00'),

-- 基础A 孙大伟 (appointment_id=8) — 全部正常
(2, 8, 1,
 '【综合评估】\n'
 '本次基础体检各项目均在正常参考范围内，健康状况良好。\n\n'
 '【检查结果】\n'
 '身高175cm，体重70kg，BMI 22.9（正常范围）。\n'
 '血压120/78mmHg（理想血压）。\n'
 '心率72次/分，律齐。\n\n'
 '【建议】\n'
 '保持现有健康生活方式，建议每年进行一次常规体检。',
 '2026-07-08 10:00'),

-- 中青年女士 李美丽 (appointment_id=9) — 全部正常
(3, 9, 1,
 '【综合评估】\n'
 '本次体检各项目指标均正常，身体健康状况良好。\n\n'
 '【检查结果】\n'
 '身高160cm，体重55kg，BMI 21.5（标准体重）。\n'
 '血压118/76mmHg（理想血压）。\n'
 '血常规各项正常，无贫血。\n'
 '肝功能、肾功能、甲状腺功能指标均在正常范围。\n'
 '肿瘤标志物（AFP、CA125、CA153）均为阴性。\n\n'
 '【建议】\n'
 '继续保持健康生活方式，建议每年定期体检。',
 '2026-07-07 11:00'),

-- 入职体检 赵小明 (appointment_id=10) — BMI偏高+心律不齐
(4, 10, 1,
 '【综合评估】\n'
 '本次入职体检发现两项需关注的问题。\n\n'
 '【异常项目】\n'
 '1. BMI 27.1，属于超重。建议控制饮食、加强运动。\n'
 '2. 心电图示窦性心律不齐，轻度，通常无临床意义，但建议心内科随访确认。\n\n'
 '【结论】\n'
 '除上述情况外，其余检查结果正常。胸部DR未见异常，视力正常，口腔卫生良好。\n'
 '总体健康状况可满足一般工作要求。',
 '2026-07-06 16:00'),

-- 心脑血管专筛 钱小红 (appointment_id=11) — 血脂全面偏高
(5, 11, 2,
 '【综合评估】\n'
 '本次心脑血管专项筛查发现血脂全面异常，心血管疾病风险较高，需积极干预。\n\n'
 '【主要异常】\n'
 '1. 总胆固醇5.8mmol/L（偏高），甘油三酯2.1mmol/L（偏高），LDL 3.8mmol/L（偏高）。\n'
 '   血脂三项均异常，提示混合型高脂血症。\n'
 '2. HDL 1.0mmol/L，处于正常低值。\n'
 '3. 颈动脉彩超未见明显斑块（目前尚好）。\n'
 '4. 心电图正常。\n\n'
 '【风险评估】\n'
 '根据血脂水平，未来10年心血管疾病风险为中度。\n\n'
 '【建议】\n'
 '1. 严格低脂饮食：减少饱和脂肪和反式脂肪摄入，增加Omega-3摄入。\n'
 '2. 每周至少150分钟中等强度运动。\n'
 '3. 建议心血管内科就诊，评估是否需要他汀类药物治疗。\n'
 '4. 3个月后复查血脂全套。',
 '2026-07-05 16:30'),

-- 白领精英 赵小明 (appointment_id=16) — 多项代谢异常
(6, 16, 3,
 '【综合评估】\n'
 '本次检查发现多项代谢指标异常，符合代谢综合征的早期表现，需系统性干预。\n\n'
 '【主要异常汇总】\n'
 '1. 体重管理：BMI 27.7，属于超重（接近肥胖）。\n'
 '2. 血糖：空腹血糖6.5mmol/L，处于糖尿病前期临界值。\n'
 '3. 血脂：总胆固醇6.8mmol/L、甘油三酯2.5mmol/L、LDL 4.2mmol/L，三项均显著偏高。\n'
 '4. 肝功能：ALT 55U/L、AST 48U/L，提示肝细胞损伤，可能与脂肪肝相关。\n\n'
 '【诊断倾向】\n'
 '代谢综合征（具备：中心性肥胖+血糖异常+血脂异常）。\n\n'
 '【建议】\n'
 '1. 生活方式干预为治疗基石：控制总热量、低脂低糖饮食、每日运动30分钟以上。\n'
 '2. 内分泌科就诊，行OGTT明确糖代谢状态。\n'
 '3. 消化内科就诊，行肝脏B超检查，明确是否存在脂肪肝。\n'
 '4. 1个月后复查肝功能和空腹血糖。\n'
 '5. 3个月后复查血脂全套。',
 '2026-07-03 16:00'),

-- 基础B 李美丽 (appointment_id=17) — 全部正常
(7, 17, 2,
 '【综合评估】\n'
 '本次基础体检各项目均正常，身体健康。\n\n'
 '【检查结果】\n'
 '身高160cm，体重54kg，BMI 21.1（正常）。\n'
 '血压115/74mmHg（理想血压）。\n'
 '血常规各项正常：WBC 5.5，RBC 4.3，HGB 130，PLT正常。\n\n'
 '【建议】\n'
 '健康状况良好，建议继续保持，每年体检一次。',
 '2026-06-30 10:30'),

-- 心脑血管专筛 周建国 (appointment_id=18) — 颈动脉斑块+心肌缺血
(8, 18, 5,
 '【综合评估】\n'
 '本次心脑血管专项检查发现重要异常：颈动脉斑块形成、心电图心肌缺血表现。\n'
 '属于心脑血管疾病高危人群，需立即启动二级预防。\n\n'
 '【关键异常】\n'
 '1. 颈动脉彩超：右侧颈动脉可见3.2×1.8mm斑块，提示动脉粥样硬化已形成。\n'
 '2. 心电图：ST-T改变，提示心肌缺血可能。\n'
 '3. 血压：148/90mmHg（1级高血压）。\n'
 '4. 血脂：总胆固醇6.1、甘油三酯2.3、LDL 4.0，全面偏高。\n'
 '5. BMI 25.9（超重）。\n\n'
 '【风险评估】\n'
 'ASCVD（动脉粥样硬化性心血管疾病）高风险。\n\n'
 '【建议】\n'
 '1. ★紧急建议：立即到心内科门诊就诊，可能需要行冠脉CTA或冠脉造影检查。\n'
 '2. 启动他汀类药物治疗（阿托伐他汀20mg/日或瑞舒伐他汀10mg/日）。\n'
 '3. 如血压持续偏高，启动降压药物治疗。\n'
 '4. 服用阿司匹林100mg/日（出血风险评估后由医生决定）。\n'
 '5. 严格生活方式管理：戒烟（如有）、限酒、低盐低脂饮食、适度运动。\n'
 '6. 1个月后复查血脂、肝功能。\n'
 '7. 6个月后复查颈动脉彩超。',
 '2026-07-01 16:00')
