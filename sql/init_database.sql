...
('13900000006', '123456', '吴志远', '320101198801015678', 1, '1988-03-15', 1, FALSE),
('13900000007', '123456', '郑晓燕', '320102199010102345', 2, '1990-10-20', 1, FALSE),
('13900000008', '123456', '冯国强', '320103197506203456', 1, '1975-07-30', 1, FALSE),
('13900000009', '123456', '陈雪梅', '320104200008084567', 2, '2000-07-12', 1, FALSE),
('13900000010', '123456', '褚建国', '320105195809095678', 1, '1958-09-09', 1, FALSE),
('13900000011', '123456', '卫小红', '320106198404045789', 2, '1984-04-04', 1, FALSE),
('13900000012', '123456', '蒋明辉', '320107199307073890', 1, '1993-12-01', 1, FALSE),
('13900000013', '123456', '沈雨彤', '320108199606063901', 2, '1996-06-06', 1, FALSE),
('13900000014', '123456', '韩建国', '320109197205052222', 1, '1972-05-05', 1, FALSE),
('13900000015', '123456', '杨桂兰', '320110196003033333', 2, '1960-07-28', 1, FALSE),
('13900000016', '123456', '朱文博', '320111199811110001', 1, '1998-11-24', 1, FALSE),
('13900000017', '123456', '秦雨涵', '320112199504041111', 2, '1995-04-04', 1, FALSE),
('13900000018', '123456', '尤德厚', '320113197808083333', 1, '1978-08-08', 1, FALSE),
('13900000019', '123456', '许丽华', '320114198609090022', 2, '1986-09-09', 1, FALSE),
('13900000020', '123456', '何永强', '320115196812120032', 1, '1968-12-12', 1, FALSE)
...
(5, 10, 2, '2026-06-20', '上午', 'COMPLETED', TRUE),
(6, 1, 1, '2026-07-13', '上午', 'PENDING',  FALSE),
(7, 4, 1, '2026-06-25', '上午', 'COMPLETED', TRUE),
(8, 3, 2, '2026-06-22', '下午', 'COMPLETED', TRUE),
(9, 6, 3, '2026-07-01', '上午', 'COMPLETED', TRUE),
(10, 5, 1, '2026-06-18', '上午', 'COMPLETED', TRUE),
(11, 7, 2, '2026-06-28', '下午', 'COMPLETED', TRUE),
(12, 9, 3, '2026-06-15', '上午', 'COMPLETED', TRUE),
(1, 2, 1, '2026-07-18', '上午', 'PENDING',  TRUE),
(2, 5, 2, '2026-07-19', '下午', 'PENDING',  FALSE),
(3, 10, 3, '2026-07-20', '上午', 'PENDING',  TRUE),
(4, 1, 1, '2026-07-21', '上午', 'PENDING',  FALSE),
(6, 7, 2, '2026-07-12', '上午', 'CANCELLED', FALSE),
(7, 9, 1, '2026-07-15', '下午', 'PENDING',  TRUE),
(8, 6, 3, '2026-06-10', '上午', 'COMPLETED', TRUE),
(9, 3, 2, '2026-06-12', '上午', 'COMPLETED', TRUE),
(10, 8, 1, '2026-06-08', '下午', 'COMPLETED', TRUE),
(12, 4, 2, '2026-06-05', '上午', 'COMPLETED', TRUE),
(13, 1, 3, '2026-07-14', '下午', 'PENDING',  FALSE),
(14, 2, 2, '2026-06-30', '上午', 'COMPLETED', TRUE),
(15, 10, 1, '2026-07-08', '上午', 'COMPLETED', TRUE),
(1, 9, 3, '2026-06-02', '下午', 'COMPLETED', TRUE),
(5, 1, 1, '2026-07-22', '上午', 'PENDING',  FALSE),
(15, 7, 2, '2026-07-23', '下午', 'PENDING',  TRUE),
(16, 6, 3, '2026-07-24', '上午', 'PENDING',  FALSE),
(17, 5, 1, '2026-07-25', '上午', 'PENDING',  TRUE),
(18, 8, 2, '2026-07-11', '下午', 'PENDING',  FALSE)
...
-- 心脑血管专筛 周建国 (appointment_id=14, doctor=2)
INSERT INTO check_results (appointment_id, item_id, doctor_id, result_value, is_abnormal, doctor_note, exam_date) VALUES
(14, 1,  2, '167', FALSE, NULL, '2026-06-20 08:30'),
(14, 2,  2, '71',  FALSE, NULL, '2026-06-20 08:30'),
(14, 3,  2, '25.4', TRUE, 'BMI仍偏高', '2026-06-20 08:30'),
(14, 4,  2, '150', TRUE, '血压较上次略降但仍偏高', '2026-06-20 08:35'),
(14, 5,  2, '90',  TRUE, '舒张压偏高', '2026-06-20 08:35'),
(14, 6,  2, '80',  FALSE, NULL, '2026-06-20 08:35'),
(14, 22, 3, '5.9', TRUE, '总胆固醇偏高', '2026-06-20 09:00'),
(14, 23, 3, '2.0', TRUE, '甘油三酯偏高', '2026-06-20 09:00'),
(14, 24, 3, '0.9', FALSE, NULL, '2026-06-20 09:00'),
(14, 25, 3, '3.6', TRUE, '低密度脂蛋白偏高', '2026-06-20 09:00'),
(14, 60, 6, '正常', FALSE, NULL, '2026-06-20 09:30'),
(14, 64, 5, '未见明显斑块', FALSE, NULL, '2026-06-20 10:00')
ON DUPLICATE KEY UPDATE result_id = result_id;

-- 白领精英 郑晓燕 (appointment_id=16, doctor=1)
INSERT INTO check_results (appointment_id, item_id, doctor_id, result_value, is_abnormal, doctor_note, exam_date) VALUES
(16, 1,  1, '163', FALSE, NULL, '2026-06-25 08:30'),
(16, 2,  1, '56',  FALSE, NULL, '2026-06-25 08:30'),
(16, 3,  1, '21.1',FALSE, NULL, '2026-06-25 08:30'),
(16, 4,  1, '112', FALSE, NULL, '2026-06-25 08:35'),
(16, 5,  1, '72',  FALSE, NULL, '2026-06-25 08:35'),
(16, 6,  1, '75',  FALSE, NULL, '2026-06-25 08:35'),
(16, 8,  3, '6.8', FALSE, NULL, '2026-06-25 09:00'),
(16, 9,  3, '4.3', FALSE, NULL, '2026-06-25 09:00'),
(16, 10, 3, '132', FALSE, NULL, '2026-06-25 09:00'),
(16, 11, 3, '280', FALSE, NULL, '2026-06-25 09:00'),
(16, 19, 3, '5.1', FALSE, NULL, '2026-06-25 09:10'),
(16, 22, 3, '4.5', FALSE, NULL, '2026-06-25 09:10'),
(16, 23, 3, '1.3', FALSE, NULL, '2026-06-25 09:10'),
(16, 32, 3, '38',  TRUE, '谷丙转氨酶轻度升高，建议近期复查', '2026-06-25 09:20'),
(16, 33, 3, '42',  TRUE, '谷草转氨酶轻度升高', '2026-06-25 09:20')
ON DUPLICATE KEY UPDATE result_id = result_id;

-- 入职体检 冯国强 (appointment_id=17, doctor=2)
INSERT INTO check_results (appointment_id, item_id, doctor_id, result_value, is_abnormal, doctor_note, exam_date) VALUES
(17, 1,  2, '178', FALSE, NULL, '2026-06-22 14:00'),
(17, 2,  2, '82',  FALSE, NULL, '2026-06-22 14:00'),
(17, 3,  2, '25.9', TRUE, 'BMI略高，建议控制体重', '2026-06-22 14:00'),
(17, 4,  2, '128', FALSE, NULL, '2026-06-22 14:05'),
(17, 5,  2, '85',  FALSE, NULL, '2026-06-22 14:05'),
(17, 6,  2, '72',  FALSE, NULL, '2026-06-22 14:05'),
(17, 8,  3, '8.2', FALSE, NULL, '2026-06-22 14:20'),
(17, 9,  3, '4.9', FALSE, NULL, '2026-06-22 14:20'),
(17, 10, 3, '150', FALSE, NULL, '2026-06-22 14:20'),
(17, 60, 6, '正常心电图', FALSE, NULL, '2026-06-22 15:00'),
(17, 61, 4, '未见异常', FALSE, NULL, '2026-06-22 15:30'),
(17, 65, 7, '1.0', FALSE, NULL, '2026-06-22 15:45'),
(17, 67, 9, '未见异常', FALSE, NULL, '2026-06-22 15:50')
ON DUPLICATE KEY UPDATE result_id = result_id;

-- 中青年女士 陈雪梅 (appointment_id=18, doctor=3)
INSERT INTO check_results (appointment_id, item_id, doctor_id, result_value, is_abnormal, doctor_note, exam_date) VALUES
(18, 1,  3, '165', FALSE, NULL, '2026-07-01 08:30'),
(18, 2,  3, '53',  FALSE, NULL, '2026-07-01 08:30'),
(18, 3,  3, '19.5', FALSE, NULL, '2026-07-01 08:30'),
(18, 4,  3, '110', FALSE, NULL, '2026-07-01 08:35'),
(18, 5,  3, '70',  FALSE, NULL, '2026-07-01 08:35'),
(18, 6,  3, '72',  FALSE, NULL, '2026-07-01 08:35'),
(18, 8,  3, '5.2', FALSE, NULL, '2026-07-01 09:00'),
(18, 9,  3, '4.5', FALSE, NULL, '2026-07-01 09:00'),
(18, 10, 3, '125', FALSE, NULL, '2026-07-01 09:00'),
(18, 19, 3, '4.8', FALSE, NULL, '2026-07-01 09:10'),
(18, 22, 3, '4.2', FALSE, NULL, '2026-07-01 09:10'),
(18, 23, 3, '0.9', FALSE, NULL, '2026-07-01 09:10'),
(18, 32, 3, '22',  FALSE, NULL, '2026-07-01 09:15'),
(18, 43, 3, '2.5', FALSE, NULL, '2026-07-01 09:20'),
(18, 48, 3, '2.8', FALSE, NULL, '2026-07-01 09:30'),
(18, 50, 3, '18',  FALSE, NULL, '2026-07-01 09:30'),
(18, 51, 3, '22',  FALSE, NULL, '2026-07-01 09:30'),
(18, 53, 3, '12',  FALSE, NULL, '2026-07-01 09:30')
ON DUPLICATE KEY UPDATE result_id = result_id;

-- 中青年男士 褚建国 (appointment_id=19, doctor=1)
INSERT INTO check_results (appointment_id, item_id, doctor_id, result_value, is_abnormal, doctor_note, exam_date) VALUES
(19, 1,  1, '172', FALSE, NULL, '2026-06-18 08:30'),
(19, 2,  1, '78',  FALSE, NULL, '2026-06-18 08:30'),
(19, 3,  1, '26.4', TRUE, 'BMI偏高', '2026-06-18 08:30'),
(19, 4,  1, '145', TRUE, '收缩压偏高', '2026-06-18 08:35'),
(19, 5,  1, '95',  TRUE, '舒张压偏高', '2026-06-18 08:35'),
(19, 6,  1, '88',  FALSE, NULL, '2026-06-18 08:35'),
(19, 8,  3, '7.1', FALSE, NULL, '2026-06-18 09:00'),
(19, 19, 3, '6.2', TRUE, '空腹血糖临界偏高', '2026-06-18 09:10'),
(19, 22, 3, '6.0', TRUE, '总胆固醇偏高', '2026-06-18 09:10'),
(19, 23, 3, '2.2', TRUE, '甘油三酯偏高', '2026-06-18 09:10'),
(19, 38, 2, '7.8', FALSE, NULL, '2026-06-18 09:20'),
(19, 39, 2, '98',  FALSE, NULL, '2026-06-18 09:20'),
(19, 40, 2, '440', TRUE, '尿酸偏高，建议控制嘌呤摄入', '2026-06-18 09:20'),
(19, 48, 3, '3.5', FALSE, NULL, '2026-06-18 09:30'),
(19, 49, 3, '2.8', FALSE, NULL, '2026-06-18 09:30'),
(19, 52, 3, '2.1', FALSE, NULL, '2026-06-18 09:30')
ON DUPLICATE KEY UPDATE result_id = result_id;

-- 银发关怀 卫小红 (appointment_id=20, doctor=2)
INSERT INTO check_results (appointment_id, item_id, doctor_id, result_value, is_abnormal, doctor_note, exam_date) VALUES
(20, 1,  2, '159', FALSE, NULL, '2026-06-28 14:00'),
(20, 2,  2, '62',  FALSE, NULL, '2026-06-28 14:00'),
(20, 3,  2, '24.5', TRUE, 'BMI偏高', '2026-06-28 14:00'),
(20, 4,  2, '138', FALSE, NULL, '2026-06-28 14:05'),
(20, 5,  2, '86',  FALSE, NULL, '2026-06-28 14:05'),
(20, 8,  3, '4.5', FALSE, NULL, '2026-06-28 14:20'),
(20, 19, 3, '7.2', TRUE, '空腹血糖偏高，建议糖耐量检查', '2026-06-28 14:30'),
(20, 38, 2, '6.5', FALSE, NULL, '2026-06-28 14:40'),
(20, 39, 2, '78',  FALSE, NULL, '2026-06-28 14:40'),
(20, 43, 3, '5.2', TRUE, 'TSH升高，建议复查甲功', '2026-06-28 15:00'),
(20, 60, 6, 'ST段轻度改变', TRUE, '建议心内科随访', '2026-06-28 15:20'),
(20, 62, 5, '未见异常', FALSE, NULL, '2026-06-28 15:40'),
(20, 64, 5, '颈动脉内膜增厚', TRUE, '建议低脂饮食、定期随访', '2026-06-28 16:00')
ON DUPLICATE KEY UPDATE result_id = result_id;

-- 糖尿病专筛 蒋明辉 (appointment_id=21, doctor=3)
INSERT INTO check_results (appointment_id, item_id, doctor_id, result_value, is_abnormal, doctor_note, exam_date) VALUES
(21, 1,  3, '180', FALSE, NULL, '2026-06-15 08:30'),
(21, 2,  3, '90',  FALSE, NULL, '2026-06-15 08:30'),
(21, 3,  3, '27.8', TRUE, '肥胖，BMI显著偏高', '2026-06-15 08:30'),
(21, 4,  3, '142', TRUE, '血压偏高', '2026-06-15 08:35'),
(21, 5,  3, '90',  FALSE, NULL, '2026-06-15 08:35'),
(21, 6,  3, '82',  FALSE, NULL, '2026-06-15 08:35'),
(21, 19, 3, '8.5', TRUE, '空腹血糖显著偏高，建议进一步检查', '2026-06-15 09:00'),
(21, 20, 3, '12.3',TRUE, '餐后血糖超标，糖尿病诊断依据之一', '2026-06-15 09:00'),
(21, 21, 3, '7.2', TRUE, '糖化血红蛋白升高，表明近3月血糖控制不佳', '2026-06-15 09:00'),
(21, 22, 3, '6.5', TRUE, '总胆固醇偏高', '2026-06-15 09:10'),
(21, 23, 3, '2.5', TRUE, '甘油三酯偏高', '2026-06-15 09:10'),
(21, 38, 2, '8.5', TRUE, '尿素氮偏高', '2026-06-15 09:20'),
(21, 39, 2, '115', TRUE, '肌酐轻度升高，肾功能需关注', '2026-06-15 09:20'),
(21, 40, 2, '380', FALSE, NULL, '2026-06-15 09:20'),
(21, 42, 2, '45',  TRUE, '尿微量白蛋白升高，提示早期肾损害', '2026-06-15 09:30'),
(21, 66, 7, '双眼糖尿病视网膜病变I期', TRUE, '建议内分泌科+眼科联合随访', '2026-06-15 10:00')
ON DUPLICATE KEY UPDATE result_id = result_id;

-- 入职体检 冯国强第二次 (appointment_id=28, doctor=2)
INSERT INTO check_results (appointment_id, item_id, doctor_id, result_value, is_abnormal, doctor_note, exam_date) VALUES
(28, 1,  2, '178', FALSE, NULL, '2026-06-12 08:30'),
(28, 2,  2, '81',  FALSE, NULL, '2026-06-12 08:30'),
(28, 3,  2, '25.6', TRUE, 'BMI略高', '2026-06-12 08:30'),
(28, 4,  2, '126', FALSE, NULL, '2026-06-12 08:35'),
(28, 5,  2, '82',  FALSE, NULL, '2026-06-12 08:35'),
(28, 6,  2, '74',  FALSE, NULL, '2026-06-12 08:35'),
(28, 8,  3, '7.8', FALSE, NULL, '2026-06-12 09:00'),
(28, 9,  3, '5.0', FALSE, NULL, '2026-06-12 09:00'),
(28, 10, 3, '148', FALSE, NULL, '2026-06-12 09:00'),
(28, 60, 6, '正常', FALSE, NULL, '2026-06-12 09:30'),
(28, 61, 4, '未见异常', FALSE, NULL, '2026-06-12 10:00'),
(28, 65, 7, '1.0', FALSE, NULL, '2026-06-12 10:15'),
(28, 67, 9, '未见异常', FALSE, NULL, '2026-06-12 10:25')
ON DUPLICATE KEY UPDATE result_id = result_id;

-- 深度筛查 褚建国 (appointment_id=29, doctor=1)
INSERT INTO check_results (appointment_id, item_id, doctor_id, result_value, is_abnormal, doctor_note, exam_date) VALUES
(29, 1,  1, '172', FALSE, NULL, '2026-06-08 14:00'),
(29, 2,  1, '76',  FALSE, NULL, '2026-06-08 14:00'),
(29, 3,  1, '25.7', TRUE, 'BMI偏高', '2026-06-08 14:00'),
(29, 4,  1, '142', TRUE, '血压仍偏高', '2026-06-08 14:05'),
(29, 5,  1, '92',  TRUE, '舒张压偏高', '2026-06-08 14:05'),
(29, 8,  3, '7.5', FALSE, NULL, '2026-06-08 14:20'),
(29, 19, 3, '6.5', TRUE, '空腹血糖偏高', '2026-06-08 14:30'),
(29, 22, 3, '6.8', TRUE, '血脂多项异常', '2026-06-08 14:30'),
(29, 32, 3, '48',  TRUE, '谷丙转氨酶升高', '2026-06-08 14:40'),
(29, 38, 2, '8.8', TRUE, '尿素氮偏高', '2026-06-08 14:50'),
(29, 39, 2, '112', TRUE, '肌酐偏高', '2026-06-08 14:50'),
(29, 40, 2, '468', TRUE, '尿酸显著偏高', '2026-06-08 14:50'),
(29, 43, 3, '3.8', FALSE, NULL, '2026-06-08 15:00'),
(29, 48, 3, '4.2', FALSE, NULL, '2026-06-08 15:10'),
(29, 60, 6, '左室高电压', TRUE, '可能与高血压相关，建议心内科会诊', '2026-06-08 15:30'),
(29, 62, 5, '脂肪肝(中度)', TRUE, '与肥胖、高血脂相关，建议减重降脂', '2026-06-08 16:00')
ON DUPLICATE KEY UPDATE result_id = result_id;

-- 白领精英 沈雨彤 (appointment_id=31, doctor=2)
INSERT INTO check_results (appointment_id, item_id, doctor_id, result_value, is_abnormal, doctor_note, exam_date) VALUES
(31, 1,  2, '160', FALSE, NULL, '2026-06-05 08:30'),
(31, 2,  2, '50',  FALSE, NULL, '2026-06-05 08:30'),
(31, 3,  2, '19.5', FALSE, NULL, '2026-06-05 08:30'),
(31, 4,  2, '105', FALSE, NULL, '2026-06-05 08:35'),
(31, 5,  2, '68',  FALSE, NULL, '2026-06-05 08:35'),
(31, 8,  3, '5.8', FALSE, NULL, '2026-06-05 09:00'),
(31, 10, 3, '118', FALSE, NULL, '2026-06-05 09:00'),
(31, 19, 3, '4.8', FALSE, NULL, '2026-06-05 09:10'),
(31, 22, 3, '4.5', FALSE, NULL, '2026-06-05 09:10'),
(31, 32, 3, '20',  FALSE, NULL, '2026-06-05 09:20'),
(31, 33, 3, '22',  FALSE, NULL, '2026-06-05 09:20')
ON DUPLICATE KEY UPDATE result_id = result_id;

-- 基础B 韩建国 (appointment_id=33, doctor=2)
INSERT INTO check_results (appointment_id, item_id, doctor_id, result_value, is_abnormal, doctor_note, exam_date) VALUES
(33, 1,  2, '175', FALSE, NULL, '2026-06-30 08:30'),
(33, 2,  2, '73',  FALSE, NULL, '2026-06-30 08:30'),
(33, 3,  2, '23.8', FALSE, NULL, '2026-06-30 08:30'),
(33, 4,  2, '122', FALSE, NULL, '2026-06-30 08:35'),
(33, 5,  2, '78',  FALSE, NULL, '2026-06-30 08:35'),
(33, 6,  2, '70',  FALSE, NULL, '2026-06-30 08:35'),
(33, 8,  3, '6.5', FALSE, NULL, '2026-06-30 09:00'),
(33, 9,  3, '4.8', FALSE, NULL, '2026-06-30 09:00'),
(33, 10, 3, '145', FALSE, NULL, '2026-06-30 09:00'),
(33, 11, 3, '260', FALSE, NULL, '2026-06-30 09:00')
ON DUPLICATE KEY UPDATE result_id = result_id;

-- 心脑血管专筛 杨桂兰 (appointment_id=34, doctor=1)
INSERT INTO check_results (appointment_id, item_id, doctor_id, result_value, is_abnormal, doctor_note, exam_date) VALUES
(34, 1,  1, '156', FALSE, NULL, '2026-07-08 08:30'),
(34, 2,  1, '58',  FALSE, NULL, '2026-07-08 08:30'),
(34, 3,  1, '23.8', FALSE, NULL, '2026-07-08 08:30'),
(34, 4,  1, '132', FALSE, NULL, '2026-07-08 08:35'),
(34, 5,  1, '84',  FALSE, NULL, '2026-07-08 08:35'),
(34, 6,  1, '72',  FALSE, NULL, '2026-07-08 08:35'),
(34, 22, 3, '5.2', FALSE, NULL, '2026-07-08 09:00'),
(34, 23, 3, '1.5', FALSE, NULL, '2026-07-08 09:00'),
(34, 24, 3, '1.2', FALSE, NULL, '2026-07-08 09:00'),
(34, 25, 3, '3.1', FALSE, NULL, '2026-07-08 09:00'),
(34, 60, 6, '正常', FALSE, NULL, '2026-07-08 09:30'),
(34, 64, 5, '未见异常', FALSE, NULL, '2026-07-08 10:00')
ON DUPLICATE KEY UPDATE result_id = result_id;

-- 糖尿病专筛 赵小明 (appointment_id=36, doctor=3)
INSERT INTO check_results (appointment_id, item_id, doctor_id, result_value, is_abnormal, doctor_note, exam_date) VALUES
(36, 1,  3, '173', FALSE, NULL, '2026-06-02 14:00'),
(36, 2,  3, '82',  FALSE, NULL, '2026-06-02 14:00'),
(36, 3,  3, '27.4', TRUE, 'BMI偏高', '2026-06-02 14:00'),
(36, 4,  3, '130', FALSE, NULL, '2026-06-02 14:05'),
(36, 5,  3, '86',  FALSE, NULL, '2026-06-02 14:05'),
(36, 6,  3, '80',  FALSE, NULL, '2026-06-02 14:05'),
(36, 19, 3, '5.8', FALSE, NULL, '2026-06-02 14:20'),
(36, 20, 3, '7.2', FALSE, NULL, '2026-06-02 14:20'),
(36, 21, 3, '5.8', FALSE, NULL, '2026-06-02 14:20'),
(36, 22, 3, '5.0', FALSE, NULL, '2026-06-02 14:25'),
(36, 23, 3, '1.6', FALSE, NULL, '2026-06-02 14:25'),
(36, 38, 2, '6.2', FALSE, NULL, '2026-06-02 14:35'),
(36, 39, 2, '85',  FALSE, NULL, '2026-06-02 14:35'),
(36, 40, 2, '350', FALSE, NULL, '2026-06-02 14:35'),
(36, 42, 2, '18',  FALSE, NULL, '2026-06-02 14:35'),
(36, 66, 7, '未见异常', FALSE, NULL, '2026-06-02 15:00')
ON DUPLICATE KEY UPDATE result_id = result_id;

-- ---------------------------------------------
-- 3.9 示例体检报告
-- ---------------------------------------------
INSERT INTO reports (appointment_id, doctor_id, summary, upload_time) VALUES
(5, 1,
 '【综合评估】本次体检发现体重指数（BMI）25.5，属于超重范围；血压155/92mmHg，达到高血压1级标准。其余检查项目未见明显异常。\n\n【医生建议】\n1. 控制饮食：低盐低脂饮食，每日食盐摄入量不超过6g，减少红肉及油炸食品摄入。\n2. 适量运动：每周至少150分钟中等强度有氧运动（如快走、游泳），逐步减重至BMI<24。\n3. 血压监测：建议连续一周早晚自测血压并记录，若持续偏高需心内科就诊。\n4. 3个月后复查血压、血脂、血糖。',
 '2026-07-09 17:00'),

(8, 1,
 '【综合评估】本次基础体检各项指标均在正常范围内。身高175cm，体重70kg，BMI 22.9，体重适中。血压120/78mmHg，心率72次/分，均正常。\n\n【医生建议】\n1. 保持当前良好的饮食和运动习惯。\n2. 建议每年进行一次常规体检。',
 '2026-07-08 17:00'),

(10, 1,
 '【综合评估】本次入职体检发现以下问题：BMI 27.1，属于超重；心电图提示轻度窦性心律不齐。其余项目（血常规、尿常规、肝肾功能、胸部X线等）均未见异常。\n\n【医生建议】\n1. 体重管理：BMI偏高，建议通过饮食控制和规律运动将体重降至标准范围。\n2. 心律不齐：轻度窦性心律不齐在年轻人中较常见，多为生理性，建议避免熬夜、减少咖啡因摄入，1个月后复查心电图。\n3. 入职结论：除上述两项需关注外，整体健康状况良好，不影响正常入职。',
 '2026-07-06 17:00'),

(11, 1,
 '【综合评估】本次心脑血管专项筛查显示血脂多项异常：总胆固醇5.8mmol/L、甘油三酯2.1mmol/L、低密度脂蛋白3.8mmol/L，均超出正常范围。心电图及颈动脉超声未见明显异常。血压、BMI正常。\n\n【医生建议】\n1. 饮食调整：严格控制饱和脂肪和反式脂肪摄入，增加膳食纤维（全谷物、蔬菜、水果），每周吃鱼2-3次。\n2. 运动干预：每周至少5次、每次30分钟以上的有氧运动。\n3. 建议服用降脂药物（他汀类），请心内科门诊就诊开具处方。\n4. 3个月后复查血脂全套。',
 '2026-07-05 17:00'),

(14, 2,
 '【综合评估】本次为周建国先生复查。与上次相比，血压从160/95mmHg降至150/90mmHg，有所改善但仍偏高；BMI 25.4，无明显变化。血脂方面：总胆固醇5.9mmol/L、甘油三酯2.0mmol/L、低密度脂蛋白3.6mmol/L，均偏高。心电图及颈动脉超声未见明显异常。\n\n【医生建议】\n1. 继续低盐低脂饮食，血压虽有下降但仍未达标，建议在医生指导下调整降压药物。\n2. 血脂持续偏高，建议加用降脂药物。\n3. 坚持每周运动计划，目标体重70kg以下。\n4. 2个月后复查血压及血脂。',
 '2026-06-20 17:00'),

(17, 2,
 '【综合评估】入职体检整体结果良好。BMI 25.9略偏高，其余检查项目（血常规、尿常规、肝功能、肾功能、心电图、胸部X线、眼科）均未见明显异常。\n\n【医生建议】\n1. 适当控制体重，BMI略超标准，建议通过增加运动量改善。\n2. 入职结论：身体健康状况符合入职要求。',
 '2026-06-22 17:00'),

(18, 3,
 '【综合评估】本次体检各项指标均在正常范围内。身高165cm，体重53kg，BMI 19.5，体重适中。血压110/70mmHg，各项生化指标及肿瘤标志物均正常。整体健康状况良好。\n\n【医生建议】\n1. 继续保持良好的生活习惯。\n2. 建议每年定期体检一次。\n3. 注意补充钙质和维生素D，保持骨密度健康。',
 '2026-07-01 17:00'),

(19, 1,
 '【综合评估】本次体检发现多项指标异常，需引起重视：\n1. 体重超标：BMI 26.4，属于超重。\n2. 血压偏高：145/95mmHg，达到高血压1级。\n3. 血糖临界：空腹血糖6.2mmol/L，处于糖尿病前期。\n4. 血脂异常：总胆固醇6.0mmol/L、甘油三酯2.2mmol/L，均偏高。\n5. 高尿酸血症：尿酸440μmol/L，超出正常范围。\n\n【医生建议】\n1. 生活方式干预是当务之急：严格控制饮食（低盐低脂低嘌呤），每日食盐<5g，避免动物内脏、海鲜、啤酒等高嘌呤食物。\n2. 每周至少5次有氧运动，目标减重至BMI<24。\n3. 血压、血糖、血脂、尿酸均需药物干预，建议心内科+内分泌科联合门诊就诊。\n4. 1个月后复查全部异常指标。',
 '2026-06-18 17:00'),

(20, 2,
 '【综合评估】本次银发关怀体检发现以下问题：\n1. BMI 24.5，处于超重临界值。\n2. 空腹血糖7.2mmol/L，偏高，建议行糖耐量试验明确糖代谢状态。\n3. TSH 5.2mIU/L，提示亚临床甲状腺功能减退可能。\n4. 心电图ST段轻度改变，需排除冠心病。\n5. 颈动脉超声提示内膜增厚，为动脉粥样硬化早期表现。\n\n【医生建议】\n1. 内分泌科就诊：完善糖耐量试验和甲状腺抗体检查，明确糖尿病及甲减诊断。\n2. 心内科就诊：结合ST段改变及颈动脉内膜增厚，建议行心脏彩超、动态心电图检查。\n3. 低盐低脂低糖饮食，每日万步走。\n4. 1个月后复查空腹血糖、甲功、血脂。',
 '2026-06-28 17:00'),

(21, 3,
 '【综合评估】本次糖尿病专项筛查结果提示代谢综合征，多项指标严重异常：\n1. 肥胖：BMI 27.8，腹型肥胖。\n2. 血糖严重异常：空腹血糖8.5mmol/L、餐后2h血糖12.3mmol/L、糖化血红蛋白7.2%，符合2型糖尿病诊断标准。\n3. 血脂异常：总胆固醇6.5mmol/L、甘油三酯2.5mmol/L。\n4. 肾功能受损：肌酐115μmol/L、尿微量白蛋白45mg/L，提示早期糖尿病肾病。\n5. 眼底检查：双眼糖尿病视网膜病变I期。\n\n【医生建议】\n1. 立即内分泌科就诊，启动规范降糖治疗（可能需要口服药联合胰岛素）。\n2. 肾内科会诊，评估肾功能损害程度，使用ACEI/ARB类药物保护肾脏。\n3. 眼科定期随访，每6个月复查眼底。\n4. 严格饮食控制（糖尿病饮食+低盐低脂），每日自测血糖并记录。\n5. 此为慢性病需终身管理，建议加入慢病管理系统，每3个月复查糖化血红蛋白。',
 '2026-06-15 17:00'),

(28, 3,
 '【综合评估】本次入职体检（第二次）结果与前次基本一致。BMI 25.6略偏高，其余项目正常。心电图、胸部X线、眼科检查均未见异常。\n\n【医生建议】\n1. BMI略高，建议适当控制体重。\n2. 入职结论：身体健康状况符合入职要求。',
 '2026-06-10 17:00'),

(34, 1,
 '【综合评估】本次心脑血管专项筛查总体结果良好。身高156cm，体重58kg，BMI 23.8，体重正常。血压132/84mmHg，处于正常高值。血脂全套：总胆固醇5.2mmol/L、甘油三酯1.5mmol/L、高密度脂蛋白1.2mmol/L、低密度脂蛋白3.1mmol/L，均在正常或临界范围。心电图正常，颈动脉超声未见异常。\n\n【医生建议】\n1. 血压处于正常高值，建议减少食盐摄入，定期监测血压。\n2. 低密度脂蛋白3.1mmol/L处于临界值，建议适量减少饱和脂肪摄入。\n3. 保持当前良好的生活习惯，每年定期体检。',
 '2026-07-08 17:00')
